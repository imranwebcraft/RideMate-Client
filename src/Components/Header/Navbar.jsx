			...
			<Container>
				...
				>
					<div className="flex items-center justify-between">
						...
						<p className=" font-semibold">RideMate</p>
					...
					>
						<div className="flex flex-col gap-y-4 gap-x-0 mt-5 sm:flex-row sm:items-center sm:justify-end sm:gap-y-0 sm:gap-x-7 sm:mt-0 sm:pl-7">
							...
							<Link
								to={'/login'}
								className="flex items-center gap-x-2 font-medium text-gray-500 hover:text-blue-600 sm:border-l sm:border-gray-300 sm:my-6 sm:pl-6 dark:border-gray-700 dark:text-gray-400 dark:hover:text-sky-500"
								href="#"
							>
								<svg
									className="w-4 h-4"
