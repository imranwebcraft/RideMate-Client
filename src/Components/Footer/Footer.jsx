...
const Footer = () => {
	return (
		<footer className="relative bg-slate-50  dark:bg-gray-800 dark:text-gray-100">
			<Container>
							...
							<div className="flex justify-start space-x-4">
								...
								>
									<svg
										...
										fill="currentColor"
										viewBox="0 0 32 32"
										className="w-5 h-5 fill-current hover:fill-sky-400 transition-all duration-300 ease-in-out"
									>
				...
				<div className="py-6 text-sm text-center dark:text-gray-400">
					© 2023 RideMate. All rights reserved.
				</div>
			</Container>
		</footer>
	);
